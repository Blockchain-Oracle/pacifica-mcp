...
const TOOLS = {
  "Market Data (free, cached)": [
    ...
    { name: "pacifica-mark-candles", description: "Mark price OHLCV candlestick data" },
  ...
  "Account Monitoring (free, cached)": [
    ...
    { name: "pacifica-account-settings", description: "Account settings: margin mode, leverage per market" },
    ...
    { name: "pacifica-order-by-id", description: "Full event history for a specific order" },
  ],
  "Trading (requires wallet, signed)": [
    ...
    { name: "pacifica-edit-order", description: "Edit an existing order's price and amount" },
    { name: "pacifica-batch-order", description: "Submit up to 10 create/cancel actions in one batch" },
    ...
    { name: "pacifica-cancel-stop", description: "Cancel a specific stop order" },
